/* Library registry (kept outside books/ so that /books/<id> URLs never collide with a file). Each entry is a folder under books/<id>/ containing:
   ...
   game: path of the 3D play page (optional; only The Little Prince), linked from the title page
...
window.LP_LIBRARY = [
  {
    ...
    game: 'books/little-prince/game/index.html',     // the chapters as a 3D play (books/little-prince/game/)
