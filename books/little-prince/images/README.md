...
`film/01-f1.jpg` … 는 영화 삽화판(`../film/index.html`)에서만 쓰는 그림입니다(1200×900 JPEG). 책의 읽기 화면에는 나오지 않습니다.
본문 속 그림 사이가 길어 한 그림이 몇 분씩 머물던 곳에 넣었습니다(2026-09-25, 71장). 이제 한 그림이 가장 오래 머무는 곳도 2분 남짓입니다. 어느 줄부터 나오는지는 `../film/frames.js`에 있습니다.
