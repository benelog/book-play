...
- 영화를 위해 더 그린 그림(`<장>-f<번호>`)도 2026-09-26부터 본문 속 그림과 같이 `images/pictures/`에 두고 본문에 `[Picture …]`로 넣습니다. 읽기 화면과 영화가 같은 그림을 씁니다. 한 그림이 1분 30초 넘게 머물지 않도록 넣었습니다.
  인물은 `images/characters/`의 기준 이미지를 따릅니다. 2026-09-26에 장 삽화·표지·본문 그림 105장의 인물을 기준 이미지대로 다시 그렸습니다(어린 왕자는 긴 코트). 방법은 `images/README.md` 끝에 있습니다.
